...
(function () {
  ...
  // Holding fires the weapon + charges; releasing fires the plasma. That whole
  // loop is driven in Game.update from Input.firing(); here we only block the
  // Space page-scroll and offer a manual plasma fire via the meter button.
  ...
  window.addEventListener('keydown', (e) => {
    ...
    else if (e.key === ' ' || e.code === 'Space') { e.preventDefault(); }
  });
